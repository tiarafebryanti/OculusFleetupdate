...
<head>
  ...
  <title>
    OCULUS FLEET | GTEI Tugboat Fleet Management
  </title>
  <!-- Font Awesome Icons -->
...
<body class="">
  ...
  <main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('https://images.pexels.com/photos/3840441/pexels-photo-3840441.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'); background-position: top;">
      <span class="mask bg-gradient-dark opacity-6"></span>
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-2 mt-5">OCULUS FLEET </h1>
            <p class="text-lead text-white">GTEI Tugboat Fleet Management</p>
          </div>
        </div>
      </div>
    </div>
